...
public class BattleShipLogic {
	...
	// declare player and AI grid of class type GridStatus
	GridStatus[][] myGrid = new GridStatus[10][10];
	GridStatus[][] rivalGrid = new GridStatus[10][10];

	// Save all data to HashMaps & ArrayList
	 ...
	 * @throws InvalidShipPlacementException throws this exception when the user
	...
	private void setShipPlacements(List<ShipPlacement> shipPlacements, GridStatus[][] grid,
			HashMap<Coordinate, ShipTypes> ships, HashMap<ShipTypes, List<Coordinate>> shipCoordinates)
	...
	/*
	 * public GridStatus[][] getGridData(String string) { // TODO Auto-generated
